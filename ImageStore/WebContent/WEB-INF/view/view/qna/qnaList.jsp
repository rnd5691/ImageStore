...
<!-- contents start -->
<div class="body">
	<form name="frm" action="qnaList.jsp" method="post" class="frm">
		<div id="qnatitle">
		<h1>QnA</h1></div>
		<div class="blank"></div>
		<div>
			<div class="search_kindS">
		...
		<table class="table table-hover">
			...
			<tr>
				<td>${dto.qna_seq}</td>
				<td>
				<a href="./${requestScope.board}View.${requestScope.board}?num=${dto.qna_seq}">${dto.title}</a></td>
				<td>${dto.nickname}</td>
				<td>${dto.contents}</td>
				<td>${dto.reg_date}</td>
			</tr>
