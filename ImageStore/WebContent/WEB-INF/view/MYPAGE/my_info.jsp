	...
	$(function(){
		...
		$("#btn").click(function(){
			if(ch==false){
				...
				document.frm.setAttribute('action', 'mypageUpdate.mypage');
			}
		});
			...
			<form name="frm" method="post">
				...
				<table class="table table-striped">
					<tr>
						<td>회원 번호</td>
						<td>
							<input type="text" name="user_num" readonly="readonly" value="${sessionScope.member.user_num}">
						</td>
					</tr>
					<tr>
						<td><span>*</span>ID</td>
						<td>
							<input id="id"type="text" name="id" readonly="readonly" value="${sessionScope.member.id}">
						</td>
					</tr>
					<tr>
						<td><span>*</span>PW</td>
					...
					<tr>
						<td><span>*</span>이메일</td>
						<td><input type="email" name="email" required="required" value="${sessionScope.member.email}"></td>
					</tr>
					<tbody id="add"></tbody>
				</table>
				<div id="btn">
